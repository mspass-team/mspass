...
\brief  Encapsulates spherical coordinates in a data structure.
 ...
 seismograms the normal convention of geographical coordinates is always
assumed.
...
typedef struct {
  ...
  **/
  double radius;
  /*!
   Zonal angle (from z) of spherical coordinates.  Units always assumed to be
  radians.
  **/
  double theta;
  /*!
   Azimuthal angle (from x) of spherical coordinates.  Units always assumed to
  be radians.
  **/
  double phi;
} SphericalCoordinate;
