...
public:
    FFTDeconOperator();
    FFTDeconOperator(const mspass::Metadata& md);
    ...
    mspass::CoreTimeSeries FourierInverse(const mspass::ComplexArray& winv, const mspass::ComplexArray& sw,
...
int ComputeFFTLength(const mspass::Metadata& md);
