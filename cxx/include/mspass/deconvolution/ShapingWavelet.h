...
public:
     ...
     */
    ShapingWavelet(const mspass::Metadata& md, int npts=0);
     ...
     *
     ...
     \param nfft - buffer size = fft length for frequency domain representation
       ...
       set the fft length.
       */
    ShapingWavelet(mspass::CoreTimeSeries d,int nfft=0);
    ...
    mspass::CoreTimeSeries impulse_response();
