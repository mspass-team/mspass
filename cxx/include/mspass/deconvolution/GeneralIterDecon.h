...
public:
    ...
    this lag. */
    ThreeCSpike(mspass::dmatrix& d, int k);
...
public:
    ...
    GeneralIterDecon(mspass::AntelopePf &md);
    ...
    int load(const mspass::CoreSeismogram& d, mspass::TimeWindow dwin);
    int loadnoise(const mspass::CoreSeismogram& d, mspass::TimeWindow nwin);
    ...
    computation. */
    int load(const mspass::CoreSeismogram& d, mspass::TimeWindow dwin, mspass::TimeWindow nwin);
    void process();
    ~GeneralIterDecon();
    mspass::CoreSeismogram getresult();
    ...
    mspass::CoreTimeSeries inverse_wavelet(double t0parent) {
...
private:
    ...
    mspass::CoreSeismogram d_all,d_decon,r,n;
    ...
    mspass::TimeWindow dwin,nwin,fftwin;
    ...
    mspass::ScalarDecon *preprocessor;
    ...
    */
    ...
    void construct_weight_penalty_function(const mspass::Metadata& md);
    ...
    */
    ...
    void print_convergence_history(ostream& ofs)
    {
        ofs << "lw_inf lw_l2 resid_l2, resid_linf"<<endl;
