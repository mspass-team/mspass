  ...
  **/
  ...
  /*!  Relative to absolute time conversion.
   ...
   variable and alters t0 by tshift.
     ...
     This method overrides the one in BasicTimeSeries to correctly reference
  gaps.
  \param tshift - time shift applied to data before switching data to absolute
  time mode.

  NOTE:  This method is maintained only for backward compatibility.   May be
  depricated in favor of method that uses internally stored private shift
  variable.
  **/
  ...
  /*! Relative to absolute time conversion.
   ...
   This method returns data previously converted to relative back to absolute
   using the internally stored time shift attribute.
