 ...
 * explicit gain cap.  It is intended as the inverse operator used to form the
 * GID peak-picking function; output shaping is applied only to the represented
 * deconvolution result and the reported actual output.
 */
