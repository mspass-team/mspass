...
def test_filter():
    ...
    filter(ts, "bandpass", freqmin=10, freqmax=12, preserve_history=True, instance='0')
    filter(seis, "bandpass", freqmin=10, freqmax=12, preserve_history=True, instance='0')
    filter(tse, "bandpass", freqmin=10, freqmax=12, preserve_history=True, instance='0')
    filter(seis_e, "bandpass",  freqmin=10, freqmax=12, preserve_history=True, instance='0')
    filter(ts, "bandstop", freqmin=10, freqmax=12)
