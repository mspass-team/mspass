...
def test_FrequencyDomainGIDDecon_shipped_defaults_recover_weak_conversion():
    _assert_shipped_default_recovers_weak_conversion(
        FrequencyDomainGIDDecon,
        FrequencyDomainGIDRFDecon,
        "FrequencyDomainGIDDecon.pf",
...
def test_FrequencyDomainGIDDecon_engine_is_dask_serializable_for_wrapper_use():
    data = _make_single_spike_convolution_data()
    pf = pfread("./data/pf/FrequencyDomainGIDDecon.pf")
    engine = FrequencyDomainGIDDecon(pf)
...
def test_FrequencyDomainGIDDecon_cnr_honors_external_noise(tmp_path):
    data = _make_single_spike_convolution_data()
    pf = _pf_with_mode(
        tmp_path,
        "FrequencyDomainGIDDecon.pf",
...
def test_FrequencyDomainGIDRFDecon_error_return_and_optional_qc():
    ...
    assert bad_window_result[0].elog.size() > 0
