...
from mspasspy.db.schema import (
    DatabaseSchema,
    MetadataSchema,
    DBSchemaDefinition,
    MDSchemaDefinition,
...
class TestSchema:
    ...
    def test_add(self):
        self.dbschema.wf_TimeSeries.add(
            "test", {"type": "boolean", "aliases": ["test1"]}
        )
        ...
        self.dbschema.channel.add(
            "test", {"type": "int", "constraint": "required", "reference": "test2"}
        )
        ...
        self.mdschema.TimeSeries.add(
            "test", {"type": "int", "constraint": "xref_key", "collection": "test2"}
        )
    ...
    def test_concept(self):
        assert (
            self.dbschema.wf_TimeSeries.concept("_id")
    ...
    def test_DBSchemaDefinition_required_keys(self):
        assert self.dbschema.wf_TimeSeries.required_keys() == [
            "_id",
            "npts",
            "delta",
            "starttime",
        ...
        assert self.dbschema.wf_Seismogram.required_keys() == [
            "_id",
            "npts",
            "delta",
            "starttime",
        ...
        assert self.dbschema.source.required_keys() == [
            "_id",
            "lat",
            "lon",
            "depth",
    ...
    def test_DBSchemaDefinition_xref_keys(self):
        ...
        assert self.dbschema.wf_Seismogram.xref_keys() == [
            "source_id",
            "site_id",
            "history_object_id",
            "elog_id",
    ...
    def test_MDSchemaDefinition_set_collection(self):
        ...
        self.mdschema.TimeSeries.set_collection(
            "site_id", "wf_Seismogram", self.dbschema
        )
    ...
    def test_MDSchemaDefinition_swap_collection(self):
        ...
        self.mdschema.TimeSeries.swap_collection(
            "dummy", "wf_TimeSeries", self.dbschema
        )
