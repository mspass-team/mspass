...
EXPECTED_MATCHER_MODULE = SOURCE_PYTHON_ROOT / "mspasspy/db/matcher.py"
...
def test_contract_suite_loads_matcher_from_this_worktree():
    assert Path(matcher_module.__file__).resolve() == EXPECTED_MATCHER_MODULE
