...
# this template is appropriate for command line tool modules
# Changes will be needed here if you use anything else.  The example
# assumes singularity and openmpi not loaded by default.
