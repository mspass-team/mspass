...
#SBATCH -p gpu-a100-dev          # Queue (partition) name - system dependent
...
HOSTNAME_BASE='ls6.tacc.utexas.edu'
...
APP_COM="apptainer run --nv $MSPASS_CONTAINER"
